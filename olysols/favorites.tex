...
\end{example}
\begin{soln}
  \begin{center}\includegraphics[scale=0.3]{2012AMO5.png}\end{center}
  Let $\alpha$ be the angle between the green and purple lines. Let $\beta$ be the angle between the green and blue lines. Let $\gamma$ be the angle between the blue and red lines.
  By Ratio Lemma,
